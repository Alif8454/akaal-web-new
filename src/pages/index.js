      ...
      <section className="section2">
        ...
        <div className="home-digi-container">
          <div className="home-digi-left">
            ...
            <p>
              Solusi berbasis teknologi yang dirancang untuk memperkuat fondasi
              digital bisnis Anda, mengoptimalkan operasional, dan menciptakan
          ...
          <div className="service-card">
            ...
            <p>
              Desain yang responsif dan strategis, dirancang untuk meningkatkan
              penjualan, memperkuat keterlibatan, dan membangun koneksi yang
          ...
          <div className="service-card">
            ...
            <p>
              ...
              performa rutin, dan perbaikan bug, agar website Anda tetap stabil,
              cepat, dan aman sepanjang waktu.
            </p>
          </div>
          ...
          <div className="service-card">
            ...
            <p>
              ...
              yang relevan untuk meningkatkan visibilitas di search engine serta
              mendatangkan trafik berkualitas ke website.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="home-agen-container">
          ...
          <div className="agencardRow">
            ...
            <div className="agencard">
              ...
              <p className="agencardText">
                Konten visual kreatif yang menarik dan relevan untuk memperkuat
                pesan brand Anda.
              </p>
            </div>
