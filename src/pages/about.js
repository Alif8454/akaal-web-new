        ...
        <div className="vismis">
          ...
          <div className="vision-mission-container">
            <div className="mission-header">
              <h2>Vision</h2>
              <p>
                Membangun ekosistem digital yang kolaboratif, terintegrasi, dan
                inovatif untuk menciptakan dampak positif yang lebih luas.
              </p>
            </div>
          </div>
            ...
            <div className="mission-section">
              ...
              <div className="mission-grid">
                ...
                <div className="mission-card">
                  ...
                  <p>
                    Memberikan layanan terbaik untuk menciptakan hubungan bisnis
                    yang berkelanjutan.
                  </p>
                </div>
                <div className="mission-card">
                ...
                <div className="mission-card">
                  ...
                  <p>
                    Mengembangkan aplikasi yang mendukung pertumbuhan wirausaha
        ...
        <div className="text-container">
          ...
          <div className="right-text">
            <p>
              ...
              kampanye berdampak. Setiap langkah kami rancang untuk menghadirkan
              cerita brand yang autentik dan berkesan.
            </p>
          </div>
        </div>
        ...
        <div className="akaalcardRow">
          ...
          <div className="akaalcardItem">
            ...
            <div className="card-text">
              ...
              <p>
                Building emotional connections through logos, voice, and visual
                ecosystems
              </p>
            </div>
          </div>
